...
export const Moves: { [index: string]: IMove[] } = {
  'Session Moves': [
    ...
    },
    {
      ...
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When you end a significant session or chapter of play,</strong> reflect on the events of the game and identify any missed opportunities to mark progress.</p>\n\n<ul>\n<li>If you strengthened your ties to a connection, <i>Reach a Milestone</i>. If there is a quest, connection, or other situation you would like to give focus in your next session, make note of it and take +1 momentum.</li>\n</ul>\n',
    },
  ],
  'Legacy Moves': [
    {
  ...
  'Adventure Moves': [
    {
      ...
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When you act in direct support of an ally</strong>, envision how you aid them. Then, <i>Gain Ground</i> and score a strong hit, you are both in control. On a <strong>weak hit</strong>, your ally is in control but you are in a bad spot.</p>\n',
    },
    {
      name: 'Check Your Gear',
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When you check to see if you have a specific helpful item or resource</strong>, roll +supply.</p>\n\n<p>On a <strong>strong hit</strong>, you have it, and are ready to act. Take +1 momentum.</p>\n\n<p>On a <strong>weak hit</strong>, you have it, but must choose one.</p>\n\n<ul>\n<li>Your supply is diminished: <i>Pay the Price</i>.</p>\n',
    },
    {
      name: 'Compel',
      source: 'Starforged Backer Preview, 081921',
  ...
  'Suffer Moves': [
    {
      ...
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When your companion faces physical hardship</strong>, they suffer -1 health for minor harm, -2 for serious harm, or -3 for major harm. If your companion&rsquo;s health is 0, <i>Lose Momentum</i> (-2). If your companion&rsquo;s health is 0, they are out of action until given aid. If their health is 0 and you rolled a miss with a match on this move, they are dead or destroyed; discard the asset.</p>\n',
    },
    {
      name: 'Endure Harm',
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When you face physical injury, fatigue, or illness</strong>, suffer -1 health for minor harm, -2 for serious harm, or -3 for major harm. If your health is 0, <i>Face Death</i>.</td>\n</tr>\n\n<tr>\n<td>36-50</td>\n<td>You are reeling and fighting to stay conscious. If you engage in any vigorous activity before taking a breather for a few minutes, roll on this table again (before resolving the other move).</td>\n</tr>\n\n<tr>\n<td>51-100</td>\n<td>You are still standing.</td>\n</tr>\n</tbody>\n</table>\n',
      oracles: ['Endure Harm'],
    },
    {
      name: 'Endure Stress',
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When you face mental strain, shock, or despair</strong>, suffer -1 spirit for minor stress, -2 for serious stress, or -3 for major stress. If your spirit is 0, <i>Forsake Your Vow</i>.</td>\n</tr>\n\n<tr>\n<td>26-50</td>\n<td>You give in to fear or compulsion, and act against your better instincts.</td>\n</tr>\n\n<tr>\n<td>51-100</td>\n<td>You persevere.</td>\n</tr>\n</tbody>\n</table>\n',
    ...
    },
    {
      ...
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When your vehicle faces a damaging situation or environment</strong>, suffer -1 integrity for minor damage, -2 for serious damage, or -3 for major damage. If your integrity is 0, <i>Sacrifice Resources</i> (-2).</td>\n</tr>\n\n<tr>\n<td>96-100</td>\n<td>Against all odds, the vehicle holds together.</td>\n</tr>\n</tbody>\n</table>\n',
  ...
  'Exploration Moves': [
    ...
    },
    {
      ...
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When you divert from an expedition to examine a notable location</strong>, roll +wits.</p>\n\n<p>On a <strong>strong hit</strong>, choose one. On a <strong>strong hit with a match</strong>, you may instead <i>Confront Chaos</i>.</p>\n',
    },
    {
  ...
  'Connection Moves': [
    ...
    },
    {
      ...
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When your relationship with a connection is tested through conflict, betrayal, or circumstance</strong>, roll +heart. If you share a bond, add +1.</p>\n\n<p>On a <strong>strong hit</strong>, <i>Swear an Iron Vow</i> (formidable or greater) to see it done. Until you complete the quest, take no benefit for the connection. If you refuse or fail the quest, the connection is permanently undone.</li>\n</ul>\n',
    },
  ],
  'Threshold Moves': [
    {
  ...
  'Recover Moves': [
    ...
    },
    {
      ...
      source: 'Starforged Backer Preview, 081921',
      keywords: '',
      text: '<p><strong>When you spend time recovering within a community</strong>, roll +heart.</p>\n\n<p>On a <strong>strong hit</strong>, this is a safe refuge. You and your allies may each choose two recover moves: <i>Pay the Price</i>.</li>\n</ul>\n',
    },
  ],
};
